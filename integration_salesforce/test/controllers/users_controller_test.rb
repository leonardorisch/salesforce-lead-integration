...
class UsersControllerTest < ActionController::TestCase
  ...
  test "should create user" do
    assert_difference('User.count') do
      post :create, user: { company: @user.company, email: @user.email, jobtitle: @user.jobtitle, lastname: @user.lastname, name: @user.name, phone: @user.phone, website: @user.website }
    end
